  ...
  return (
    <div
      ...
      style={{
        ...
        flex: fullWidth || small ? undefined : 1,
        alignSelf: small ? "flex-start" : undefined,
        borderRadius: small ? 15 : 24,
        background: COLORS.primary,
        color: "#fff",
        fontSize: small ? 12 : 14.5,
        fontWeight: 600,
        boxShadow: small
          ? "0 6px 12px -6px rgba(255,138,92,0.6)"
          : "0 12px 24px -12px rgba(255,138,92,0.7)",
        padding: small ? "0 12px" : undefined,
        flexShrink: 0,
      }}
    >
      {icon}
