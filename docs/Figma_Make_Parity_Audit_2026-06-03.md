...
| Screen60 安全中心 | `renderSafety` | 已接入-需视觉复核 | 已补安全中心页面；2026-06-22 追加宠友圈举报、拉黑、黑名单列表和解除拉黑入口。 |
| Screen61 黑名单管理 | `renderSafety` 黑名单区 | 已接入-需视觉复核 | 已在安全中心内接入黑名单列表和解除拉黑，不新增独立路由。 |
