...
- “用量成本”和“供应商监控”仍需补齐更完整的 provider 原始状态、SLA 时间点和成本口径后再做成独立看板。
...
- `GET /admin/social/greetings`
- `GET /admin/social/walk-invites`
- `GET /admin/conversations`
- `GET /admin/conversations/{conversationId}`
- `GET /admin/conversations/{conversationId}/messages`
- `POST /admin/conversations/{conversationId}/messages/{messageId}/hide`
