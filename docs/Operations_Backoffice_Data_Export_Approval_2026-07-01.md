...
当前已支持高风险审批人/申请人分离和 `highRiskApproval.requiredApprovals` 最少会签人数；生产期建议配置为 2 或以上，并补审批值守通知和敏感字段授权。
...
- 导出审批：展示待审批/已审批申请，支持提交审批、审批通过、取消和按审批下载。
