...
- 体重记录和趋势接口。
- 健康备忘、就诊记录接口。
- ~~健康提醒通知。~~ MVP 已支持疫苗提醒开关、通知中心健康提醒、真机本地系统通知调度；标记完成、关闭通知或退出账号会取消对应本地提醒。
...
- ~~健康提醒与系统通知状态提示。~~ 疫苗提醒开启后，如果系统通知权限或 App 通知开关未开启，App 会明确提示“系统通知需在设置中开启”；权限和开关都开启时会安排真机本地系统通知，并在标记完成、关闭通知或退出账号时取消。
