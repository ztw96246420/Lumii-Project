...
- 配置中心已支持草稿、高风险确认、版本回滚和单 admin 发布审批；生产期仍需多管理员双人审批、定时发布和 A/B 分流。
...
- prompt/provider 调整必须走配置中心发布、草稿、审批、版本历史和审计链路。
...
- 生产期配置发布仍应继续补齐多管理员双人审批、定时发布和灰度人群。
...
- 双人审批。
- 配置草稿和单 admin 审批已落地；生产期补双人审批、灰度、定时发布。
- 审核员绩效和误杀/漏杀复盘。
- 地点合并、详情编辑与质量运营深化。
- 用户风险评分。
- 聊天举报和骚扰治理。
