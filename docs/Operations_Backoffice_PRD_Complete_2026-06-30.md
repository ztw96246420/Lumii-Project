...
- 地点质量分、重复候选、地点详情编辑、地点图片审核、人工确认后的地点合并、自定义审核模板和基础地点贡献账本已接入；用户本人公开贡献身份和轻量等级已接入，排行榜或活动奖励仍待定。
...
- 用户本人公开贡献身份和轻量等级已接入；排行榜、活动奖励或兑换策略仍待定。
...
11. 地点贡献分已支持用户本人公开徽章和轻量等级展示；是否接排行榜、活动奖励或兑换规则？
