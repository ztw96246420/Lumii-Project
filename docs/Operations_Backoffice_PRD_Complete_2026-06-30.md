...
- 下载动作写审计，并记录筛选条件。
- 导出页展示最近导出记录，可直接追溯数据集、文件名、筛选条件、导出行数、管理员、IP 和时间。
- 不导出图片二进制。
- 不导出完整设备 token。
...
- 头像/宠物图审核。
- 举报聚合和证据快照。
- 地点审核模板已基础落地；生产期补自定义模板维护和重复地点处理。
