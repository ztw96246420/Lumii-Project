...
- 批量回复审批。
- 更正式的客服质检制度：抽检规则、周/月 KPI、外包客服结算口径、质检申诉和多角色权限。
...
- 工单 SLA 配置、负责人枚举、客服排班、首响/解决 SLA 拆分、基础质量统计、排班冲突检测和批量处理复盘已基础落地；生产期补客服质检制度、周/月 KPI、外包结算口径和批量回复审批。
- 真实厂商 Push 基础通道。
- 数据导出双人审批和敏感字段授权。
...
4. 工单客服质检制度、周/月 KPI、外包结算口径和批量回复审批。
5. 地点合并与地点编辑。
