...
async function main() {
  ...
  const result = {
    ...
    push: {
      ...
      summary: pick(notifications?.summary, [
        'pushEnabled',
        'pushProvider',
        'pushReceiptEnabled',
        'pushAttempted',
        ...
        'pushFailed',
        'pushSuccessRate',
        'pushReceiptAttempted',
        'pushReceiptOk',
        'pushReceiptFailed',
        'pushReceiptPending',
        'pushReceiptSuccessRate',
        'businessPushDeliveries',
        'businessPushAttempted',
        'businessPushSent',
        'businessPushFailed',
        'businessPushReceiptAttempted',
        'businessPushReceiptOk',
        'businessPushReceiptFailed',
        'businessPushReceiptPending',
        'campaignPushAttempted',
        'campaignPushSent',
        'campaignPushFailed',
        'campaignPushReceiptAttempted',
        'campaignPushReceiptOk',
        'campaignPushReceiptFailed',
        'campaignPushReceiptPending',
      ]),
    },
