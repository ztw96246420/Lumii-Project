...
function buildGptImage2PetAvatarPrompt(user) {
  ...
  return [
    ...
    '- isolated clean warm white / off-white studio background',
    'Accessory handling:',
...
async function startGptImage2AvatarJob(user, job, media) {
  ...
  Object.assign(job, {
    ...
    promptVersion: 'gpt-image-2-collectible-character-v2',
    status: 'processing',
  });
