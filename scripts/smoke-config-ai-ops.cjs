...
async function main() {
  ...
  try {
    ...
    assert.ok(initial.data.ai.avatar.gptImage2.promptTemplate.includes('#FFFDFC'));
    assert.ok(initial.data.ai.avatarAnimation.seedance.dogPromptTemplate.includes('#00FF00'));
