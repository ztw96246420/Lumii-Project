...
const suites = [
  ...
  { key: 'journald-persistence', title: 'Persistent journald retention', script: 'smoke-journald-persistence.cjs', timeoutMs: 30_000 },
  ...
  { key: 'legacy-media-url-migration', title: 'Legacy media URL migration', script: 'smoke-legacy-media-url-migration.cjs', timeoutMs: 180_000 },
  ...
  { key: 'audit-cos-archive', title: 'Audit COS immutable archive', script: 'smoke-admin-audit-cos-archive.cjs', timeoutMs: 180_000 },
  ...
  { key: 'admin-notifications-page', title: 'Admin notifications page', script: 'smoke-admin-notifications-page.cjs', timeoutMs: 180_000, visual: true },
